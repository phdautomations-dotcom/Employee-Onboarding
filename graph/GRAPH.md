...
_Generated 2026-09-07 by `scripts/graphify.mjs`. 103 files, 389 import edges._
...
- `src/components/common/Icon.jsx` — 48 importers
- `src/context/AppContext.jsx` — 32 importers
- `src/components/common/Button.jsx` — 28 importers
- `src/utils/format.js` — 26 importers
- `src/constants/statuses.js` — 23 importers
- `src/context/ToastContext.jsx` — 14 importers
- `src/components/common/States.jsx` — 13 importers
- `src/components/common/Badge.jsx` — 10 importers
- `src/components/common/Card.jsx` — 10 importers
- `src/constants/roles.js` — 10 importers
- `src/components/common/Modal.jsx` — 9 importers
- `src/components/common/SearchBar.jsx` — 9 importers
...
- **`src/components/navigation/CandidateHeader.jsx`**
  71 loc · imports 4 · imported by 1 · exports: default (CandidateHeader)
  imports: `src/components/common/Icon.jsx`, `src/components/common/Button.jsx`, `src/components/navigation/RoleSwitcher.jsx`, `src/context/AppContext.jsx`
  importedBy: `src/layouts/CandidateLayout.jsx`
- **`src/components/navigation/GlobalSearch.jsx`**
  76 loc · imports 2 · imported by 2 · exports: default (GlobalSearch)
  imports: `src/components/common/Icon.jsx`, `src/context/AppContext.jsx`
  importedBy: `src/components/navigation/TATopbar.jsx`, `src/components/navigation/Topbar.jsx`
- **`src/components/navigation/NotificationBell.jsx`**
  44 loc · imports 3 · imported by 2 · exports: default (NotificationBell)
...
- **`src/components/navigation/RoleSwitcher.jsx`**
  54 loc · imports 3 · imported by 2 · exports: default (RoleSwitcher)
  imports: `src/components/common/Icon.jsx`, `src/context/AppContext.jsx`, `src/constants/roles.js`
  importedBy: `src/components/navigation/CandidateHeader.jsx`, `src/components/navigation/Topbar.jsx`
- **`src/components/navigation/Sidebar.jsx`**
  45 loc · imports 1 · imported by 1 · exports: default (Sidebar)
...
- **`src/components/navigation/Topbar.jsx`**
  32 loc · imports 5 · imported by 1 · exports: default (Topbar)
...
- **`src/pages/candidate/ApplicationSuccessPage.jsx`**
  76 loc · imports 2 · imported by 1 · exports: default (ApplicationSuccessPage)
  imports: `src/components/common/Icon.jsx`, `src/components/common/Button.jsx`
  importedBy: `src/routes/AppRoutes.jsx`
- **`src/pages/candidate/ApplyPage.jsx`**
  352 loc · imports 8 · imported by 1 · exports: default (ApplyPage)
  imports: `src/components/common/Icon.jsx`, `src/components/common/Button.jsx`, `src/components/common/Field.jsx`, `src/context/AppContext.jsx`, `src/context/ToastContext.jsx`, `src/utils/resumeParser.js`, `src/hooks/useLocalStorage.js`, `src/utils/ids.js`
  importedBy: `src/routes/AppRoutes.jsx`
- **`src/pages/candidate/CandidateProfilePage.jsx`**
  77 loc · imports 6 · imported by 1 · exports: default (CandidateProfilePage)
  imports: `src/components/common/Icon.jsx`, `src/components/common/Button.jsx`, `src/components/common/Card.jsx`, `src/components/common/States.jsx`, `src/context/AppContext.jsx`, `src/utils/format.js`
  importedBy: `src/routes/AppRoutes.jsx`
- **`src/pages/candidate/JobDetailsPage.jsx`**
  101 loc · imports 5 · imported by 1 · exports: default (JobDetailsPage)
  imports: `src/components/common/Icon.jsx`, `src/components/common/Button.jsx`, `src/components/common/States.jsx`, `src/context/AppContext.jsx`, `src/utils/format.js`
  importedBy: `src/routes/AppRoutes.jsx`
- **`src/pages/candidate/JobsPage.jsx`**
  91 loc · imports 6 · imported by 1 · exports: default (JobsPage)
  imports: `src/components/JobCard.jsx`, `src/components/common/Button.jsx`, `src/components/common/SearchBar.jsx`, `src/components/common/FilterSelect.jsx`, `src/components/common/States.jsx`, `src/context/AppContext.jsx`
  importedBy: `src/routes/AppRoutes.jsx`
- **`src/pages/candidate/LandingPage.jsx`**
  114 loc · imports 6 · imported by 1 · exports: default (LandingPage)
  imports: `src/components/common/Button.jsx`, `src/components/JobCard.jsx`, `src/components/common/SearchBar.jsx`, `src/components/common/FilterSelect.jsx`, `src/components/common/States.jsx`, `src/context/AppContext.jsx`
  importedBy: `src/routes/AppRoutes.jsx`
- **`src/pages/candidate/MyApplicationPage.jsx`**
  372 loc · imports 14 · imported by 1 · exports: default (MyApplicationPage)
  imports: `src/components/common/Icon.jsx`, `src/components/common/Button.jsx`, `src/components/common/Card.jsx`, `src/components/common/Badge.jsx`, `src/components/common/States.jsx`, `src/components/common/Timeline.jsx`, `src/components/workflow/RecruitmentTimeline.jsx`, `src/components/workflow/OnboardingJourney.jsx`, `src/components/common/Modal.jsx`, `src/components/common/FileUpload.jsx`, `src/context/AppContext.jsx`, `src/context/ToastContext.jsx`, `src/constants/statuses.js`, `src/utils/format.js`
  importedBy: `src/routes/AppRoutes.jsx`
...
- **`src/pages/hr/HRCandidateDetailPage.jsx`**
  32 loc · imports 4 · imported by 1 · exports: default (HRCandidateDetailPage)
  imports: `src/components/common/Button.jsx`, `src/components/common/States.jsx`, `src/components/workflow/CandidateProfile.jsx`, `src/context/AppContext.jsx`
  importedBy: `src/routes/AppRoutes.jsx`
- **`src/pages/hr/HRCandidatesPage.jsx`**
  145 loc · imports 11 · imported by 1 · exports: default (HRCandidatesPage)
  imports: `src/components/common/Table.jsx`, `src/components/common/Badge.jsx`, `src/components/common/Avatar.jsx`, `src/components/common/Button.jsx`, `src/components/common/SearchBar.jsx`, `src/components/common/FilterSelect.jsx`, `src/components/common/StatTiles.jsx`, `src/components/common/States.jsx`, `src/context/AppContext.jsx`, `src/constants/statuses.js`, `src/utils/format.js`
  importedBy: `src/routes/AppRoutes.jsx`
- **`src/pages/hr/HRDashboard.jsx`**
  102 loc · imports 11 · imported by 1 · exports: default (HRDashboard)
  imports: `src/components/common/Card.jsx`, `src/components/common/Metric.jsx`, `src/components/common/PipelineFunnel.jsx`, `src/components/common/Avatar.jsx`, `src/components/common/Button.jsx`, `src/components/common/Icon.jsx`, `src/components/common/Timeline.jsx`, `src/components/common/States.jsx`, `src/context/AppContext.jsx`, `src/constants/statuses.js`, `src/utils/format.js`
  importedBy: `src/routes/AppRoutes.jsx`
- **`src/pages/hr/HRDocumentsPage.jsx`**
  6 loc · imports 1 · imported by 1 · exports: default (HRDocumentsPage)
  imports: `src/pages/shared/DocumentsReview.jsx`
  importedBy: `src/routes/AppRoutes.jsx`
- **`src/pages/hr/HREmployeesPage.jsx`**
  164 loc · imports 14 · imported by 1 · exports: default (HREmployeesPage)
  imports: `src/components/common/Table.jsx`, `src/components/common/Badge.jsx`, `src/components/common/Avatar.jsx`, `src/components/common/Metric.jsx`, `src/components/common/Button.jsx`, `src/components/common/SearchBar.jsx`, `src/components/common/Card.jsx`, `src/components/common/States.jsx`, `src/components/common/Modal.jsx`, `src/components/workflow/OnboardingJourney.jsx`, `src/context/AppContext.jsx`, `src/context/ToastContext.jsx`, `src/constants/statuses.js`, `src/utils/format.js`
  importedBy: `src/routes/AppRoutes.jsx`
- **`src/pages/hr/HROffersPage.jsx`**
  166 loc · imports 12 · imported by 1 · exports: default (HROffersPage)
...
- **`src/pages/shared/DocumentsReview.jsx`**
  116 loc · imports 10 · imported by 2 · exports: default (DocumentsReview)
  imports: `src/components/common/Table.jsx`, `src/components/common/Badge.jsx`, `src/components/common/Button.jsx`, `src/components/common/SearchBar.jsx`, `src/components/common/FilterSelect.jsx`, `src/components/workflow/ReasonModal.jsx`, `src/context/AppContext.jsx`, `src/context/ToastContext.jsx`, `src/constants/statuses.js`, `src/utils/format.js`
  importedBy: `src/pages/hr/HRDocumentsPage.jsx`, `src/pages/talentAcquisition/TADocumentsPage.jsx`
...
- **`src/pages/talentAcquisition/TACandidateDetailPage.jsx`**
  325 loc · imports 16 · imported by 1 · exports: default (TACandidateDetailPage)
...
- **`src/pages/talentAcquisition/TACandidatesPage.jsx`**
  186 loc · imports 10 · imported by 1 · exports: default (TACandidatesPage)
...
- **`src/pages/talentAcquisition/TADashboard.jsx`**
  227 loc · imports 14 · imported by 1 · exports: default (TADashboard)
...
- **`src/components/common/Avatar.jsx`**
  24 loc · imports 1 · imported by 4 · exports: default (Avatar), Identity
  imports: `src/utils/format.js`
  importedBy: `src/components/workflow/CandidateProfile.jsx`, `src/pages/hr/HRCandidatesPage.jsx`, `src/pages/hr/HRDashboard.jsx`, `src/pages/hr/HREmployeesPage.jsx`
- **`src/components/common/Badge.jsx`**
  23 loc · imports 2 · imported by 10 · exports: Badge, StatusBadge
  imports: `src/components/common/Icon.jsx`, `src/constants/statuses.js`
  importedBy: `src/components/common/DocumentCard.jsx`, `src/components/workflow/CandidateProfile.jsx`, `src/components/workflow/DocumentTable.jsx`, `src/pages/candidate/MyApplicationPage.jsx`, `src/pages/hr/HRCandidatesPage.jsx`, `src/pages/hr/HREmployeesPage.jsx`, `src/pages/hr/HROffersPage.jsx`, `src/pages/shared/DocumentsReview.jsx`, `src/pages/talentAcquisition/TAInterviewsPage.jsx`, `src/pages/talentAcquisition/TAOffersPage.jsx`
- **`src/components/common/Button.jsx`**
  31 loc · imports 1 · imported by 28 · exports: default (Button)
  imports: `src/components/common/Icon.jsx`
  importedBy: `src/components/JobCard.jsx`, `src/components/common/FileUpload.jsx`, `src/components/common/Modal.jsx`, `src/components/navigation/CandidateHeader.jsx`, `src/components/workflow/CandidateProfile.jsx`, `src/components/workflow/CreateJobDrawer.jsx`, `src/components/workflow/DocumentTable.jsx`, `src/components/workflow/InterviewResultModal.jsx`, `src/components/workflow/OfferDrawer.jsx`, `src/components/workflow/ReasonModal.jsx`, `src/components/workflow/ScheduleInterviewModal.jsx`, `src/pages/LoginPage.jsx`, `src/pages/candidate/ApplicationSuccessPage.jsx`, `src/pages/candidate/ApplyPage.jsx`, `src/pages/candidate/CandidateProfilePage.jsx`, `src/pages/candidate/JobDetailsPage.jsx`, `src/pages/candidate/JobsPage.jsx`, `src/pages/candidate/LandingPage.jsx`, `src/pages/candidate/MyApplicationPage.jsx`, `src/pages/hr/HRCandidateDetailPage.jsx`, `src/pages/hr/HRCandidatesPage.jsx`, `src/pages/hr/HRDashboard.jsx`, `src/pages/hr/HREmployeesPage.jsx`, `src/pages/hr/HROffersPage.jsx`, `src/pages/shared/DocumentsReview.jsx`, `src/pages/shared/SettingsPage.jsx`, `src/pages/talentAcquisition/TAInterviewsPage.jsx`, `src/pages/talentAcquisition/TAOffersPage.jsx`
- **`src/components/common/Card.jsx`**
  51 loc · imports 1 · imported by 10 · exports: Card, KPICard, InfoList
  imports: `src/components/common/Icon.jsx`
  importedBy: `src/components/workflow/CandidateProfile.jsx`, `src/components/workflow/OfferDrawer.jsx`, `src/pages/candidate/CandidateProfilePage.jsx`, `src/pages/candidate/MyApplicationPage.jsx`, `src/pages/hr/HRDashboard.jsx`, `src/pages/hr/HREmployeesPage.jsx`, `src/pages/hr/HROffersPage.jsx`, `src/pages/shared/ActivityFeed.jsx`, `src/pages/shared/ProfilePage.jsx`, `src/pages/shared/SettingsPage.jsx`
...
- **`src/components/common/Field.jsx`**
  ...
  imports: `src/components/common/Icon.jsx`
  importedBy: `src/components/workflow/CreateJobDrawer.jsx`, `src/components/workflow/InterviewResultModal.jsx`, `src/components/workflow/OfferDrawer.jsx`, `src/components/workflow/ReasonModal.jsx`, `src/components/workflow/ScheduleInterviewModal.jsx`, `src/pages/candidate/ApplyPage.jsx`
- **`src/components/common/FileUpload.jsx`**
  112 loc · imports 2 · imported by 1 · exports: default (FileUpload)
  imports: `src/components/common/Icon.jsx`, `src/components/common/Button.jsx`
  importedBy: `src/pages/candidate/MyApplicationPage.jsx`
- **`src/components/common/FilterSelect.jsx`**
  31 loc · imports 1 · imported by 8 · exports: default (FilterSelect)
  imports: `src/components/common/Icon.jsx`
  importedBy: `src/pages/candidate/JobsPage.jsx`, `src/pages/candidate/LandingPage.jsx`, `src/pages/hr/HRCandidatesPage.jsx`, `src/pages/hr/HROffersPage.jsx`, `src/pages/shared/ActivityFeed.jsx`, `src/pages/shared/DocumentsReview.jsx`, `src/pages/talentAcquisition/TAInterviewsPage.jsx`, `src/pages/talentAcquisition/TAOffersPage.jsx`
- **`src/components/common/Icon.jsx`**
  35 loc · imports 0 · imported by 48 · exports: default (Icon)
...
- **`src/components/common/Metric.jsx`**
  28 loc · imports 0 · imported by 2 · exports: default (Metric)
  importedBy: `src/pages/hr/HRDashboard.jsx`, `src/pages/hr/HREmployeesPage.jsx`
- **`src/components/common/Modal.jsx`**
  80 loc · imports 2 · imported by 9 · exports: Modal, Drawer, ConfirmDialog
  imports: `src/components/common/Icon.jsx`, `src/components/common/Button.jsx`
...
- **`src/components/common/PipelineFunnel.jsx`** — Horizontal funnel of the recruitment pipeline. `stages` = [{ label, value, muted? }]
  24 loc · imports 0 · imported by 1 · exports: default (PipelineFunnel)
  importedBy: `src/pages/hr/HRDashboard.jsx`
- **`src/components/common/ProgressRing.jsx`**
  24 loc · imports 0 · imported by 1 · exports: default (ProgressRing)
  importedBy: `src/components/workflow/OnboardingJourney.jsx`
- **`src/components/common/SearchBar.jsx`**
  16 loc · imports 1 · imported by 9 · exports: default (SearchBar)
  imports: `src/components/common/Icon.jsx`
  importedBy: `src/pages/candidate/JobsPage.jsx`, `src/pages/candidate/LandingPage.jsx`, `src/pages/hr/HRCandidatesPage.jsx`, `src/pages/hr/HREmployeesPage.jsx`, `src/pages/hr/HROffersPage.jsx`, `src/pages/shared/ActivityFeed.jsx`, `src/pages/shared/DocumentsReview.jsx`, `src/pages/talentAcquisition/TAInterviewsPage.jsx`, `src/pages/talentAcquisition/TAOffersPage.jsx`
...
- **`src/components/common/States.jsx`**
  38 loc · imports 1 · imported by 13 · exports: EmptyState, LoadingState, Spinner, SkeletonRows
  imports: `src/components/common/Icon.jsx`
  importedBy: `src/components/common/Table.jsx`, `src/components/workflow/CandidateProfile.jsx`, `src/pages/candidate/CandidateProfilePage.jsx`, `src/pages/candidate/JobDetailsPage.jsx`, `src/pages/candidate/JobsPage.jsx`, `src/pages/candidate/LandingPage.jsx`, `src/pages/candidate/MyApplicationPage.jsx`, `src/pages/hr/HRCandidateDetailPage.jsx`, `src/pages/hr/HRCandidatesPage.jsx`, `src/pages/hr/HRDashboard.jsx`, `src/pages/hr/HREmployeesPage.jsx`, `src/pages/shared/ActivityFeed.jsx`, `src/pages/talentAcquisition/TAOffersPage.jsx`
- **`src/components/common/StatTiles.jsx`** — Compact stat-tile row for list / pipeline pages. tiles = [{ n, label, tone?: 'accent' | 'warn', onClick?, active? }]
  35 loc · imports 0 · imported by 1 · exports: default (StatTiles)
  importedBy: `src/pages/hr/HRCandidatesPage.jsx`
- **`src/components/common/Stepper.jsx`**
  23 loc · imports 1 · imported by 0 · exports: default (Stepper)
  imports: `src/components/common/Icon.jsx`
- **`src/components/common/Table.jsx`**
  83 loc · imports 2 · imported by 7 · exports: Pagination, DataTable
  imports: `src/components/common/Icon.jsx`, `src/components/common/States.jsx`
  importedBy: `src/components/workflow/DocumentTable.jsx`, `src/pages/hr/HRCandidatesPage.jsx`, `src/pages/hr/HREmployeesPage.jsx`, `src/pages/hr/HROffersPage.jsx`, `src/pages/shared/DocumentsReview.jsx`, `src/pages/talentAcquisition/TAInterviewsPage.jsx`, `src/pages/talentAcquisition/TAOffersPage.jsx`
- **`src/components/common/Timeline.jsx`**
  62 loc · imports 2 · imported by 4 · exports: ActivityTimeline, StageTracker
  imports: `src/components/common/Icon.jsx`, `src/utils/format.js`
  importedBy: `src/components/workflow/CandidateProfile.jsx`, `src/pages/candidate/MyApplicationPage.jsx`, `src/pages/hr/HRDashboard.jsx`, `src/pages/shared/ActivityFeed.jsx`
...
- **`src/components/JobCard.jsx`**
  51 loc · imports 2 · imported by 2 · exports: default (JobCard)
  imports: `src/components/common/Icon.jsx`, `src/components/common/Button.jsx`
...
- **`src/components/ta/Avatar.jsx`**
  ...
  imports: `src/utils/format.js`
  importedBy: `src/pages/talentAcquisition/TACandidateDetailPage.jsx`, `src/pages/talentAcquisition/TACandidatesPage.jsx`, `src/pages/talentAcquisition/TADashboard.jsx`
- **`src/components/ta/Button.jsx`**
  13 loc · imports 1 · imported by 3 · exports: default (Button)
  imports: `src/components/common/Icon.jsx`
  importedBy: `src/pages/talentAcquisition/TACandidateDetailPage.jsx`, `src/pages/talentAcquisition/TAJobDetailPage.jsx`, `src/pages/talentAcquisition/TAJobsPage.jsx`
- **`src/components/ta/Card.jsx`** — Plain premium card. Optional header with a title and a right-side action.
  15 loc · imports 0 · imported by 3 · exports: default (Card)
  importedBy: `src/pages/talentAcquisition/TACandidateDetailPage.jsx`, `src/pages/talentAcquisition/TADashboard.jsx`, `src/pages/talentAcquisition/TAJobDetailPage.jsx`
- **`src/components/ta/DataGrid.jsx`**
  55 loc · imports 3 · imported by 3 · exports: default (DataGrid)
  imports: `src/components/common/Icon.jsx`, `src/components/ta/EmptyState.jsx`, `src/components/ta/Pager.jsx`
  importedBy: `src/pages/talentAcquisition/TACandidatesPage.jsx`, `src/pages/talentAcquisition/TADashboard.jsx`, `src/pages/talentAcquisition/TAJobsPage.jsx`
- **`src/components/ta/DonutChart.jsx`** — Donut chart for a small set of categories (<= 5). `slices` = [{ label, value, color }]. Identity is shown in the legend with value + percent, so it never rests on colour alone.
  64 loc · imports 0 · imported by 1 · exports: default (DonutChart)
  importedBy: `src/pages/talentAcquisition/TADashboard.jsx`
- **`src/components/ta/EmptyState.jsx`**
  14 loc · imports 1 · imported by 3 · exports: default (EmptyState)
  imports: `src/components/common/Icon.jsx`
  importedBy: `src/components/ta/DataGrid.jsx`, `src/pages/talentAcquisition/TACandidateDetailPage.jsx`, `src/pages/talentAcquisition/TAJobDetailPage.jsx`
- **`src/components/ta/FunnelChart.jsx`** — Stage funnel matching the reference: coloured trapezoid bands that narrow down the pipeline, with the conversion percent (from the first stage) on the right. `stages` = [{ label, value, color }] in pipeline order.
  39 loc · imports 0 · imported by 1 · exports: default (FunnelChart)
  importedBy: `src/pages/talentAcquisition/TADashboard.jsx`
- **`src/components/ta/KpiCard.jsx`**
  44 loc · imports 2 · imported by 1 · exports: default (KpiCard)
...
- **`src/components/ta/Tag.jsx`**
  13 loc · imports 1 · imported by 5 · exports: default (Tag)
  imports: `src/components/common/Icon.jsx`
  importedBy: `src/pages/talentAcquisition/TACandidateDetailPage.jsx`, `src/pages/talentAcquisition/TACandidatesPage.jsx`, `src/pages/talentAcquisition/TADashboard.jsx`, `src/pages/talentAcquisition/TAJobDetailPage.jsx`, `src/pages/talentAcquisition/TAJobsPage.jsx`
- **`src/components/ta/TAHeader.jsx`**
  19 loc · imports 0 · imported by 5 · exports: default (TAHeader)
  importedBy: `src/pages/talentAcquisition/TACandidateDetailPage.jsx`, `src/pages/talentAcquisition/TACandidatesPage.jsx`, `src/pages/talentAcquisition/TADashboard.jsx`, `src/pages/talentAcquisition/TAJobDetailPage.jsx`, `src/pages/talentAcquisition/TAJobsPage.jsx`
- **`src/components/ta/Toolbar.jsx`**
  42 loc · imports 1 · imported by 2 · exports: default (Toolbar)
  imports: `src/components/common/Icon.jsx`
  importedBy: `src/pages/talentAcquisition/TACandidatesPage.jsx`, `src/pages/talentAcquisition/TAJobsPage.jsx`
- **`src/components/workflow/CandidateProfile.jsx`**
  526 loc · imports 19 · imported by 1 · exports: default (CandidateProfile)
  imports: `src/components/common/Icon.jsx`, `src/components/common/Button.jsx`, `src/components/common/Card.jsx`, `src/components/common/Badge.jsx`, `src/components/common/Avatar.jsx`, `src/components/common/Timeline.jsx`, `src/components/common/States.jsx`, `src/components/workflow/ReasonModal.jsx`, `src/components/workflow/ScheduleInterviewModal.jsx`, `src/components/workflow/InterviewResultModal.jsx`, `src/components/workflow/OfferDrawer.jsx`, `src/components/workflow/DocumentTable.jsx`, `src/components/workflow/RecruitmentTimeline.jsx`, `src/components/workflow/OnboardingJourney.jsx`, `src/context/AppContext.jsx`, `src/context/ToastContext.jsx`, `src/data/jobs.js`, `src/constants/statuses.js`, `src/utils/format.js`
...
- **`src/components/workflow/DocumentTable.jsx`**
  92 loc · imports 7 · imported by 1 · exports: default (DocumentTable)
  ...
  importedBy: `src/components/workflow/CandidateProfile.jsx`
- **`src/components/workflow/InterviewResultModal.jsx`**
  61 loc · imports 4 · imported by 3 · exports: default (InterviewResultModal)
  ...
  importedBy: `src/components/workflow/CandidateProfile.jsx`, `src/pages/talentAcquisition/TACandidateDetailPage.jsx`, `src/pages/talentAcquisition/TAInterviewsPage.jsx`
- **`src/components/workflow/OfferDrawer.jsx`**
  128 loc · imports 5 · imported by 3 · exports: default (OfferDrawer)
  ...
  importedBy: `src/components/workflow/CandidateProfile.jsx`, `src/pages/talentAcquisition/TACandidateDetailPage.jsx`, `src/pages/talentAcquisition/TAOffersPage.jsx`
- **`src/components/workflow/OnboardingJourney.jsx`**
  52 loc · imports 3 · imported by 3 · exports: default (OnboardingJourney)
  imports: `src/components/common/Icon.jsx`, `src/components/common/ProgressRing.jsx`, `src/constants/statuses.js`
  importedBy: `src/components/workflow/CandidateProfile.jsx`, `src/pages/candidate/MyApplicationPage.jsx`, `src/pages/hr/HREmployeesPage.jsx`
- **`src/components/workflow/ReasonModal.jsx`**
  54 loc · imports 3 · imported by 5 · exports: default (ReasonModal)
  imports: `src/components/common/Modal.jsx`, `src/components/common/Button.jsx`, `src/components/common/Field.jsx`
  importedBy: `src/components/workflow/CandidateProfile.jsx`, `src/components/workflow/DocumentTable.jsx`, `src/pages/hr/HROffersPage.jsx`, `src/pages/shared/DocumentsReview.jsx`, `src/pages/talentAcquisition/TACandidateDetailPage.jsx`
- **`src/components/workflow/RecruitmentTimeline.jsx`**
  65 loc · imports 3 · imported by 2 · exports: default (RecruitmentTimeline)
  imports: `src/components/common/Icon.jsx`, `src/constants/statuses.js`, `src/utils/format.js`
  importedBy: `src/components/workflow/CandidateProfile.jsx`, `src/pages/candidate/MyApplicationPage.jsx`
- **`src/components/workflow/ScheduleInterviewModal.jsx`**
  88 loc · imports 5 · imported by 2 · exports: default (ScheduleInterviewModal)
  ...
  importedBy: `src/components/workflow/CandidateProfile.jsx`, `src/pages/talentAcquisition/TACandidateDetailPage.jsx`

### hook

- **`src/hooks/useCollectionView.js`**
  74 loc · imports 0 · imported by 2 · exports: useCollectionView
  importedBy: `src/pages/talentAcquisition/TACandidatesPage.jsx`, `src/pages/talentAcquisition/TAJobsPage.jsx`
...
- **`src/context/AppContext.jsx`**
  629 loc · imports 6 · imported by 32 · exports: AppProvider, useApp
...
- **`src/context/ToastContext.jsx`**
  50 loc · imports 1 · imported by 14 · exports: ToastProvider, useToast, useToastList
...
- **`src/utils/metrics.js`** — Small pure helpers for dashboard numbers and charts. Everything here works on the real app data — no fake values.
  46 loc · imports 0 · imported by 1 · exports: countInWindow, trendPercent, weeklyCounts, groupCounts
  importedBy: `src/pages/talentAcquisition/TADashboard.jsx`
...
- **`src/constants/roles.js`**
  30 loc · imports 0 · imported by 10 · exports: ROLES, ROLE_META, DEMO_USERS
  importedBy: `src/App.jsx`, `src/components/navigation/RoleSwitcher.jsx`, `src/components/navigation/TASidebar.jsx`, `src/components/navigation/TATopbar.jsx`, `src/components/navigation/Topbar.jsx`, `src/context/AppContext.jsx`, `src/layouts/HRLayout.jsx`, `src/pages/LoginPage.jsx`, `src/pages/shared/ProfilePage.jsx`, `src/pages/talentAcquisition/TADashboard.jsx`
- **`src/constants/statuses.js`** — ============================================================ Centralized status system. Every status has: label, tone (badge variant), icon (lucide name). ============================================================
  178 loc · imports 0 · imported by 23 · exports: APP_STATUS, STATUS_META, statusMeta, PIPELINE_STAGES, stageIndexForStatus, stageBadgeForStatus, ROUND_STATUS, ROUND_STATUS_META, DOC_STATUS, DOC_STATUS_META, OFFER_STATUS, OFFER_STATUS_META, REQUIRED_DOCUMENTS, DOC_CATEGORIES, INTERVIEW_TYPES, INTERVIEW_MODES
  importedBy: `src/components/common/Badge.jsx`, `src/components/common/DocumentCard.jsx`, `src/components/workflow/CandidateProfile.jsx`, `src/components/workflow/DocumentTable.jsx`, `src/components/workflow/InterviewResultModal.jsx`, `src/components/workflow/OnboardingJourney.jsx`, `src/components/workflow/RecruitmentTimeline.jsx`, `src/components/workflow/ScheduleInterviewModal.jsx`, `src/context/AppContext.jsx`, `src/data/seed.js`, `src/layouts/HRLayout.jsx`, `src/pages/candidate/MyApplicationPage.jsx`, `src/pages/hr/HRCandidatesPage.jsx`, `src/pages/hr/HRDashboard.jsx`, `src/pages/hr/HREmployeesPage.jsx`, `src/pages/hr/HROffersPage.jsx`, `src/pages/shared/DocumentsReview.jsx`, `src/pages/talentAcquisition/TACandidateDetailPage.jsx`, `src/pages/talentAcquisition/TACandidatesPage.jsx`, `src/pages/talentAcquisition/TADashboard.jsx`, `src/pages/talentAcquisition/TAInterviewsPage.jsx`, `src/pages/talentAcquisition/TAJobDetailPage.jsx`, `src/pages/talentAcquisition/TAOffersPage.jsx`

### data

- **`src/data/jobs.js`**
  253 loc · imports 0 · imported by 5 · exports: JOBS, findJob
  importedBy: `src/components/workflow/CandidateProfile.jsx`, `src/context/AppContext.jsx`, `src/data/seed.js`, `src/pages/talentAcquisition/TACandidateDetailPage.jsx`, `src/pages/talentAcquisition/TAOffersPage.jsx`
- **`src/data/seed.js`**
  636 loc · imports 3 · imported by 1 · exports: buildSeed
...
- **`src/index.css`**
  963 loc · imports 0 · imported by 1
  importedBy: `src/main.jsx`
- **`src/styles/ta.css`**
  546 loc · imports 0 · imported by 1
  importedBy: `src/main.jsx`

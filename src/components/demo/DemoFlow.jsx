...
const STEPS = [
  ...
  { role: ROLES.TA, who: 'Talent Acquisition', title: 'Prepare & send the offer', hint: 'Fill the offer details and send it — the candidate gets it by email.', to: (a) => `/ta/candidates/${a.candidateId}`, at: 9 },
  { role: ROLES.TA, who: 'Talent Acquisition', title: 'Confirm offer accepted', hint: 'The candidate replies by email — click “Confirm offer accepted” on their profile.', to: (a) => `/ta/candidates/${a.candidateId}`, at: 10 },
